...
<body>
<form name="infoWriteForm" method="post" action="/VodShopping/info/infoWrite.do">
	<table width=100% cellpadding=0 cellspacing=0 border=0>
		<tr>
			<td height=500 style="border:10px solid #fff" valign=top>
					...
					<table width=100% cellpadding=0 cellspacing=0 border=0>
						<tr>
							...
							<tr>
								...
								<td><input type=text name="infoSubject" style="width:100%" required></td>
							</tr>
							<tr>
								<td colspan=2 height=1 bgcolor="#DEDEDE" style="padding:0px;"></td>
							</tr>
							<tr>
								...
								<td>
									<textarea name="infoContent" id="content" style="width:655px;height:350px" required></textarea>
								</td>
							</tr>
							</table>
							</td>
				...
				<TABLE width=100%>
					<tr>
						<td align=center style="padding-top:5"><input type="image" src="../image/btn_upload.gif" onclick="javascript:chk()"></td>
					</tr>
				</TABLE>
				<TABLE width=100% cellpadding=0 cellspacing=0 border=0>
					<TR>
